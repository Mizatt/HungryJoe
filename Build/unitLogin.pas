...
begin
  formCriaConta.Show;
  Self.Hide;
  {AnimateWindow(PanelCadastrar.Handle,300,AW_HOR_POSITIVE); //Animação da Janela
    Animações possíveis:
...
begin
  ...
  if QueryLogin.RecordCount = 0 then
    begin
      mensagem := 'Nome de usuário ou senha inválidos. Caso tenha esquecido login ou senha, consulte o administrador. ';
